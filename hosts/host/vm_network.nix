{ lib, ... }: {
  networking = {
    ...
    nat = {
      extraCommands = ''
        iptables -A PREROUTING -t nat -p gre --src 85.93.44.211 -j DNAT --to-destination 192.168.100.1
      ...
      '';
      extraStopCommands = ''
        iptables -D PREROUTING -t nat -p gre --src 85.93.44.211 -j DNAT --to-destination 192.168.100.1 || true
